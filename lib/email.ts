...
const FROM = process.env.EMAIL_FROM || 'FixitFlow - Interactive Electronics Repair Guides <noreply@example.com>';
const APP_NAME = 'FixitFlow - Interactive Electronics Repair Guides';
