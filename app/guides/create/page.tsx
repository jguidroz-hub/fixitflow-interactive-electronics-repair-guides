...
export default function Guides/createPage() {
  const [items, setItems] = useState<Guides/createItem[]>([]);
  ...
  const handleDelete = async (id: string) => {
    await fetch(`/api/guides/create/${id}`, { method: 'DELETE' });
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-bold">Create Repair Guide</h1>
        <button
      ...
      <p className="text-gray-600 mb-6">Step-by-step guide creation interface</p>
