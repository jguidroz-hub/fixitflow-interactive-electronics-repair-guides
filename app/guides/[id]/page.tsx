...
export default function GuidesDetailPage() {
  const [items, setItems] = useState<GuidesDetailItem[]>([]);
  ...
  const handleDelete = async (id: string) => {
    await fetch(`/ApiGuidesDetail/${id}`, { method: 'DELETE' });
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-bold">Repair Guide Details</h1>
        <button
      ...
      <p className="text-gray-600 mb-6">Interactive step-by-step repair process</p>
